...
namespace TVRename.Forms
{
    public partial class UI
    {
        ...
        public void InitializeComponent()
        {
            ...
            refreshWTWTimer = new System.Windows.Forms.Timer(components);
            notifyIcon1 = new NotifyIcon(components);
            showRightClickMenu = new ContextMenuStrip(components);
            statusTimer = new System.Windows.Forms.Timer(components);
            BGDownloadTimer = new System.Windows.Forms.Timer(components);
            UpdateTimer = new System.Windows.Forms.Timer(components);
            saveFile = new SaveFileDialog();
            tmrShowUpcomingPopup = new System.Windows.Forms.Timer(components);
            quickTimer = new System.Windows.Forms.Timer(components);
            tmrPeriodicScan = new System.Windows.Forms.Timer(components);
